...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    private static final String WEATHER_REQUEST_URL = "weather_request_url";
    ...
    private void loadWeatherData() {
        ...
        argsBundle.putString(WEATHER_REQUEST_URL, weatherRequestUrl.toString());

        LoaderManager loaderManager = getSupportLoaderManager();
        Loader<String[]> weatherLoader = loaderManager.getLoader(WEATHER_LOADER_ID);
        if (weatherLoader == null) {
            loaderManager.initLoader(WEATHER_LOADER_ID, argsBundle, this);
        } else {
            loaderManager.restartLoader(WEATHER_LOADER_ID, argsBundle, this);
        }
    }
    ...
    private static class MyAsyncTaskLoader extends AsyncTaskLoader<String[]> {
        ...
        public String[] loadInBackground() {
            try {
                URL requestUrl = new URL(args.getString(WEATHER_REQUEST_URL));
                String jsonWeatherResponse = NetworkUtils
                        .getResponseFromHttpUrl(requestUrl);

                return OpenWeatherJsonUtils
                        .getSimpleWeatherStringsFromJson(mainActivity, jsonWeatherResponse);
