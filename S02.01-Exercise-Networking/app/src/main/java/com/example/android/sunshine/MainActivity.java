...
public class MainActivity extends AppCompatActivity {
    ...
    public void loadWeatherData() {
        String locationQuery = "San Francisco";
        URL forecastURL = NetworkUtils.buildUrl(locationQuery);
    ...
    private class FetchWeatherTask extends AsyncTask<URL, Void, String> {
        ...
        protected String doInBackground(URL... urls) {
            ...
            try {
                forecastResult = NetworkUtils.getResponseFromHttpUrl(searchUrl);
            } catch (IOException e) {
                e.printStackTrace();
            }
        ...
        protected void onPostExecute(String forecastResult) {
            if (forecastResult != null && !forecastResult.equals("")) {
                mWeatherTextView.setText(forecastResult);
            }
        }
    }
}