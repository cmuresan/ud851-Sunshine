...
//      COMPLETED (21) Implement LoaderManager.LoaderCallbacks<Cursor>
    ...
    private static final int INDEX_COLUMN_WIND_SPEED = 6;
...
//  COMPLETED (10) Remove the mWeatherDisplay TextView declaration
    ...
    private TextView selectedDayDate;
    private TextView selectedDayDescription;
    private TextView selectedDayHighTemperature;
    private TextView selectedDayLowTemperature;
    private TextView selectedDayHumidity;
    private TextView selectedDayPressure;
    private TextView selectedDayWind;

    private static final int ID_DETAILS_LOADER = 55;
...
//      COMPLETED (13) Find each of the TextViews by ID
        selectedDayDate = (TextView) findViewById(R.id.selected_day_date);
        selectedDayDescription = (TextView) findViewById(R.id.selected_day_description);
        selectedDayHighTemperature = (TextView) findViewById(R.id.selected_day_high_temperature);
        selectedDayLowTemperature = (TextView) findViewById(R.id.selected_day_low_temperature);
        selectedDayHumidity = (TextView) findViewById(R.id.selected_day_humidity);
        selectedDayPressure = (TextView) findViewById(R.id.selected_day_pressure);
        selectedDayWind = (TextView) findViewById(R.id.selected_day_wind);
...
//          COMPLETED (23) If the loader requested is our detail loader, return the appropriate CursorLoader
        switch (id) {
            ...
            default:
                throw new RuntimeException("Loader Not Implemented:" + mUri);
...
//      COMPLETED (25) Check before doing anything that the Cursor has valid data
        ...
        long dateInMillis = data.getLong(INDEX_COLUMN_DATE);
        ...
        double pressure = data.getDouble(INDEX_COLUMN_PRESSURE);
        float wind = data.getFloat(INDEX_COLUMN_WIND_SPEED);
        float degrees = data.getFloat(INDEX_COLUMN_DEGREES);
        String windString = SunshineWeatherUtils.getFormattedWind(this, wind, degrees);


//      COMPLETED (26) Display a readable data string
        selectedDayDate.setText(dateString);
//      COMPLETED (27) Display the weather description (using SunshineWeatherUtils)
        selectedDayDescription.setText(description);
//      COMPLETED (28) Display the high temperature
        selectedDayHighTemperature.setText(String.valueOf(high));
//      COMPLETED (29) Display the low temperature
        selectedDayLowTemperature.setText(String.valueOf(low));
//      COMPLETED (30) Display the humidity
        selectedDayHumidity.setText(String.valueOf(humidity));
//      COMPLETED (31) Display the wind speed and direction
        selectedDayWind.setText(windString);
//      COMPLETED (32) Display the pressure
        selectedDayPressure.setText(String.valueOf(pressure));
//      COMPLETED (33) Store a forecast summary in mForecastSummary
        mForecastSummary = dateString + " - " + description + " - " + high + " - " + low + " - " +
                humidity + " - " + windString + " - " + pressure;
