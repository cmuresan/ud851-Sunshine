...
public class SunshineSyncUtils {
    ...
    private static final int SUNSHINE_SYNC_INTERVAL_HOURS = 4;
    private static final int SUNSHINE_SYNC_INTERVAL_SECONDS = (int) TimeUnit.HOURS.toSeconds(SUNSHINE_SYNC_INTERVAL_HOURS);
    ...
    synchronized public static void scheduleWeatherSync(@NonNull Context context) {
        ...
        Job syncJob = firebaseJobDispatcher.newJobBuilder()
                ...
                .setRecurring(true)
                .setTrigger(Trigger.executionWindow(SUNSHINE_SYNC_INTERVAL_SECONDS, 2 * SUNSHINE_SYNC_INTERVAL_SECONDS))
