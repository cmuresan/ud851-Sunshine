...
//              COMPLETED (14) Check if a day has passed since the last notification
                long sinceLastNotif = SunshinePreferences.getEllapsedTimeSinceLastNotification(context);
                boolean oneDayPassed = sinceLastNotif >= DateUtils.DAY_IN_MILLIS;

//              COMPLETED (15) If more than a day have passed and notifications are enabled, notify the user
                if (notificationsEnabled && oneDayPassed) {
